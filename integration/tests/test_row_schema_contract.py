...
def test_segment_row_matches_migration_columns(nightly_run):
    ...
    # id is generated by the database default rather than supplied by the writer.
    missing = _required_columns(columns) - set(row) - {"id"}
...
def test_reel_row_matches_migration_columns(nightly_run):
    ...
    missing = _required_columns(columns) - set(row) - {"id", "created_at"}
