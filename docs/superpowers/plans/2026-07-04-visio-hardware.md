...
- [ ] **Step 2: Order all BOM line items**
...
- [ ] **Step 3: Verify total spend against budget**
...
- [ ] **Step 4: Inventory check on arrival**
...
- [ ] **Step 2: First boot with USB power only (no PiJuice yet)**
...
- [ ] **Step 4: Verify camera module is detected**
...
- [ ] **Step 1: Mount the PiJuice Zero pHAT**
...
- [ ] **Step 2: Verify PiJuice is powering the Pi**
...
- [ ] **Step 3: Verify PiJuice reports battery charge via API**
...
- [ ] **Step 4: Wire the WS2812B NeoPixel**
...
- [ ] **Step 5: Wire the tactile button**
...
- [ ] **Step 2: Start a realistic recording load**
...
- [ ] **Step 4: Run to depletion or extrapolate**
...
- [ ] **Step 5: Compare against spec estimate**
...
- [ ] **Step 2: Assemble the internal stack**
...
- [ ] **Step 4: Close the enclosure and re-verify boot**
...
- [ ] **Step 3: Button accessibility check**
